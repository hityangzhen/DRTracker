...
# -static_profile $tool_path/static_profile/static_profile_1.out \
# -instrumented_lines $tool_path/static_profile/instrumented_lines_1.out \
# -ignore_lib 1 -enable_debug 0 -debug_pthread 1 -debug_mem 1 -debug_main 1 \
# -debug_pthread 1 -debug_malloc 1 -- test/verify/verifier1
